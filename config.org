...
# Want to use python3 instead of the default python2
# #+BEGIN_SRC emacs-lisp
# (setq org-babel-python-command "python3")
# #+END_SRC

Want to use f95 instead of gfortran for fortran
#+BEGIN_SRC emacs-lisp
...
#   :ensure t)
# #+end_src
Have to make sure that flake8 and jedi are installed
...
| Collecting   | mccabe<0.5,>=0.2.1                  | (from                               | flake8)      |            |                |        |
...
| Successfully | installed                           | flake8-2.5.1                        | mccabe-0.4.0 | pep8-1.7.0 | pyflakes-1.0.0 |        |
| Collecting   | jedi                                |                                     |              |            |                |        |
| Using        | cached                              | jedi-0.9.0-py2.py3-none-any.whl     |              |            |                |        |
| Installing   | collected                           | packages:                           | jedi         |            |                |        |
| Successfully | installed                           | jedi-0.9.0                          |              |            |                |        |
| Collecting   | flake8                              |                                     |              |            |                |        |
| Using        | cached                              | flake8-2.5.4-py2.py3-none-any.whl   |              |            |                |        |
| Collecting   | mccabe<0.5,>=0.2.1                  | (from                               | flake8)      |            |                |        |
| Using        | cached                              | mccabe-0.4.0-py2.py3-none-any.whl   |              |            |                |        |
